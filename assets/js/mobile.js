...
function showModalFilt(){
	var elem = document.querySelectorAll('#modalfilter')[0];
	var instance = M.Modal.getInstance(elem);
	instance.open();
}

function showModalAbout(){
	var elem = document.querySelectorAll('#modalabout')[0];
	var instance = M.Modal.getInstance(elem);
	instance.open();
}

function showModalCountry(){
	var elem = document.querySelectorAll('#modalcountry')[0];
	var instance = M.Modal.getInstance(elem);
	instance.open();
}
...
$(document).ready(function () {
  ...
  if ($("#modalsearch").length) {
  	$("#modalsearch").focus(function() {
  		showModalFilt();
  	});
  }
  if ($("#home_country").length) {
    $("#home_country").on('change', function(e) {
       $("#pickct-form").submit();
    });
  }
